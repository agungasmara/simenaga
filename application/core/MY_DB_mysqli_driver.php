...
class MY_DB_mysqli_driver extends CI_DB_mysqli_driver {
  ...
  function insert_on_duplicate_update_batch($table = '', $set = NULL)
  {
    if ( ! is_null($set))
    {
     ...
     // echo "<pre>"; print_r($this->set_insert_batch($set));
     // echo "<pre>"; print_r($this->qb_keys);
     // echo "<pre>"; print_r(isset($this->qb_from[0]));die;
   ...
   * @return string
   ...
   HARUS diimplementasikan method ini di database biar bisa pakai fungsi di bawah /dode note
   ALTER TABLE rekap_gaji ADD CONSTRAINT uk_rekap_gaji UNIQUE (id_pegawai, jenis_gaji, periode_gaji)
   */
